...
Exposure of `r params$Patient_Name` (`r params$Patient_ID`), DOB: `r format(ymd(params$DOB), "%d/%m/%Y")`, Sex: `r params$Gender`
...
*Table 2. Tissue reactions from single-delivery radiation dose to skin of the neck, torso, pelvis, buttocks, or arms (Balter et al, 2010).*

```{r skin_reactions, message=FALSE, echo=FALSE}
knitr::include_graphics("skin_reactions.png")
```
